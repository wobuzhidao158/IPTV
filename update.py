...
# 你要的全套分类（央视频道/卫视/电影/少儿/港澳台/新加坡/影视轮播）
CATEGORIES = [
    {"name":"央视频道","kw":["CCTV","央视","cctv","中央"]},
    {"name":"卫视频道","kw":["卫视","江苏","浙江","湖南","北京","东方","山东","安徽","湖北","广东","四川","重庆","河南"]},
    {"name":"电影频道","kw":["电影","影院","院线","影视","剧场"]},
    {"name":"儿童频道","kw":["少儿","儿童","卡通","动画","动漫"]},
...
def main():
    ...
    # 日志
    log = f"[{datetime.now()}]本地{len(local_lines)}行+远程{len(remote_lines)}行→有效合并{len(chans)}个\n"
